...
`research/studies/ccp_entry_models.py`.
...
* `audit/liquidity_grab_rate.py` — the grab fires at least 1.8x as often as
...
`audit/ccp_at_grabs_check.py`, Min15 gives roughly 2,700 grabs per 20-day
