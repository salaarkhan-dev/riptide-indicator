# Why section 12 draws fewer BOS and CHoCH than the reference
    ...
    python3 indicators/riptide_ms/studies/ms_bos_gate.py
...
emphasis of everything above.**
    ...
    python3 indicators/riptide_ms/studies/ms_period_grid.py
...
`indicators/riptide_ms/studies/ms_period_grid.py`, same data, cells are
