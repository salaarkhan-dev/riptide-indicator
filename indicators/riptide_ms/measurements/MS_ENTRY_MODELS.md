...
Studies: `indicators/riptide_ms/studies/ms_entry_models.py` and `ms_entry_diag.py`, outputs
alongside them.
...
`indicators/riptide_ms/port/ms_struct.py` — a transcription of section 12 of
