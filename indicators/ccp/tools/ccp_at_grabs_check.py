...
shape, a grab of a LOW a bullish one.
    ...
    python3 indicators/ccp/tools/ccp_at_grabs_check.py
"""
...
from indicators.ccp.tools.ccp_merge_check import atr14, name_of  # noqa: E402
...
if __name__ == "__main__":
    # indicators/ccp/tools/ccp_anchor_check.py imports grabs() from here.
    asyncio.run(main())
