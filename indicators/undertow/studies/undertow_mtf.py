...
BASE = U.P(locTol=0, pinPick=U.PICK_READY, pinAt=U.PIN_PULL, pinLag=0, biasGate=U.BG_TRADEABLE, famStrict=False, armWins=False, stopSrc=U.S_PULL, useBackup=False, biasSrc=U.BS_STRUCT, pinNewest=False, famPriority=False, failTest=U.T_CLOSE, confirmOrder=U.C_EITHER, maxLive=64, feeFrac=FEE, rr=3.5,
