        ...
        for em in END_MINOR:
            for h in HTF:
                for rr in RRS:
                    ...
                    yield U.P(pinPick=U.PICK_READY, pinAt=U.PIN_PULL, pinLag=0, maxLive=4, biasGate=U.BG_TRADEABLE, famStrict=False, armWins=False, stopSrc=U.S_PULL, useBackup=False, pinNewest=False, famPriority=False, failTest=U.T_CLOSE, biasSrc=U.BS_STRUCT, endMinor=em, htfMult=h, rr=rr, feeFrac=FEE,
