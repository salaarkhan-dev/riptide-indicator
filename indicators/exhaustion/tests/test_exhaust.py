...
indicators/exhaustion/port/td.py, which the measurement ran on, and
riptide/watchers/exhaust.py, which the bot runs. They are deliberately not one module: research/ pulls in the
...
from memory instead of from a study. The exhaust_rate.py study beside this
file exists so it can be rerun, and this pins the bot's own RATE table to it.

    PYTHONPATH=. python3 indicators/exhaustion/tests/test_exhaust.py
...
from riptide.watchers.exhaust import (                 # noqa: E402
    RATE, SPEC, _counts, _label, rate, sig_of)
from riptide.watchers import Hit                       # noqa: E402
from indicators.exhaustion.port.td import counts as td_counts  # noqa: E402
