...
## Sweep + FVG + a trendline BREAKOUT agreeing — `(removed with the trendline)`
...
`indicators/ccp/studies/fvg_continuation.py` · 60 symbols · Hour8 trend must agree · target 2R
