...
LEGEND = (
    ...
    "<b>3.12% risk · skip</b> — the stop is more than 2.6% from the entry.\n"
    "Over 333 days and 626 confirmed setups, a stop wider than 2.6% of price "
    "wins <b>26%</b> of the time and returns <b>-0.226 R</b>, against "
    "<b>41%</b> and <b>+0.141 R</b> for everything at or under it.\n"
    "It is the best-evidenced thing on the alert after the volume gate: "
    "against a circular-shift null it scored 2.84 where the null's p95 was "
    "1.38 and its <b>maximum over 300 rotations was 1.95</b> — larger than "
    "every rotation — and the sign holds in <b>4 quarters of 4</b>. Fees are "
    ...
    "<b>There is deliberately no \'take\'.</b> A lower bound at 1.2% was "
    "tested at the same time and failed both checks — 0.77 against a p95 of "
    "1.74, sign in only 2 quarters of 4, and no better with fees switched off. "
    "So a narrow stop gets no verdict, because the evidence did not support "
    "one. Confirmed setups only.\n\n"
