...
LEGEND = (
    ...
    "<b>2.50% risk · take</b> — where this setup's stop sits, as a share of "
    "price.\n"
    "Measured over 333 days on 628 confirmed signals, with round bands fixed "
    "in advance rather than fitted:\n"
    "<code>0.0-0.8%  32% win  -0.107\n"
    "0.8-1.2%  38% win  +0.060   marginal\n"
    "1.2-1.6%  45% win  +0.229   take\n"
    "1.6-2.0%  41% win  +0.104   take\n"
    "2.0-2.6%  46% win  +0.330   take\n"
    "2.6-3.5%  25% win  -0.245\n"
    "over 3.5% 28% win  -0.194</code>\n"
    "1.2 to 2.6 is one block of three bands and the sharpest edge is at 2.6, "
    "where the win rate roughly halves. Both tails have a reason: a tight stop "
    "pays a large fee as a share of R, and a very wide one means the raid "
    "itself was violent, which is a move continuing rather than exhausting.\n"
    "<b>UNPROVEN.</b> It holds in three quarters of four, it is the best of "
    "six comparisons that were looked at, and the strict null has not been run "
    "on it. It weights a decision, it never blocks an alert. Shown on "
    "confirmed setups only — the same bands on early signals come out "
    "incoherent, so there is no verdict to give there.\n\n"
