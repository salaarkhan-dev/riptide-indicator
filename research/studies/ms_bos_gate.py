...
The engine loop below is a PATCHED COPY of research/ms_struct.py's, carrying
the extra counters. The original is left alone because deploy/ms-py-parity.py
compares it, statement by statement, to the Pine.
"""
...
from research.ms_struct import ms_swings
