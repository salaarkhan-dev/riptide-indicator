...
Pre-registered in PREREG_fvg_h1_holdout.md, committed before this ran.
    ...
    python3 research/studies/fvg_h1_holdout.py
...
horizon, the pivot width — is IMPORTED from research/studies/ccp_context_filters.py
rather than restated. A copy would be free to drift, and a holdout testing a
subtly different filter tests nothing.
"""
...
from research.studies.ccp_context_filters import (        # noqa: E402
